...
def _contains_godot_prefixes(filename: str) -> bool:
    godot_prefixes_to_exclude = ["TIMER_", "PROCESS_", "SPACE_", "KEY_", "JOY_", "FREEZE_", "TRANSPARENCY_", "EASE_", "TRANS_", "MOUSE_", "TYPE_", "THREAD_", "AUTOWRAP_", "WINDOW_", "ERROR_", "ERR_", "BYTE_", "MSAA_"]
