...
func get_panning_camera_position(camera: Camera2D) -> Vector2:
	...
	var final_mouse_global_pos = (viewport.get_screen_transform() * viewport.get_canvas_transform()).affine_inverse() * current_mouse_screen_position
	var mouse_global_diff = original_mouse_global_position - final_mouse_global_pos
